...
4. Build docker image containers (Check the docker-compose.yml for the configurations)
   ```sh
   docker-compose up
   ```
   
5. Create database schema and populate the table using the following scripts.
